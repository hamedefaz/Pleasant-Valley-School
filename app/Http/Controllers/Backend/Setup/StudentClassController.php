...
class StudentClassController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $data->save();
        return redirect()->route('setups.student.class.view')->with('success', 'Data insertion successful!');
    }
    ...
    public function delete($id){
        $data = StudentClass::find($id);
        $data->delete();
        return redirect()->route('setups.student.class.view')->with('success', 'Data deletion successful!');
    }
}
