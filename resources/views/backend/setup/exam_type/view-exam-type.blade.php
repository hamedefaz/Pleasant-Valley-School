  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MANAGE STUDENT EXAM TYPE</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a title="Delete" id="delete" class="btn btn-sm btn-danger" href="{{route('setups.exam.type.delete',$value->id)}}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
