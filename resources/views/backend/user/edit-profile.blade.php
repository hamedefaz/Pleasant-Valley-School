                    ...
                    <form method="post" action="{{route('profiles.update')}}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="address" value="{{$editData->mobile}}" class="form-control">
                                ...
                                <div class="form-group col-md-12">
                                    <p style="text-align:center;"><img id="showImage" src="{{(!empty($editData->image))?url('public/upload/user_images/'.$editData->image):url('public/upload/no_image.png')}}" style="width: 300px; height: 320px; border: 2px solid #000;"></p>
                                </div>

                                <div class="form-group col-md-12" style="padding-top: 10px;">
                                    <p style="text-align:center;"><input type="submit" value="Update" class="btn btn-primary"></p>
                                </div>
                        </div>
                    </form>
              </div><!-- /.card-body -->
